...
using ARC.Stream.Emulator.Template.Configuration;
...
public class Config : Configurable<Config>
{
    ...
    [DisplayName("Dump Emulated ARC Files")]
    [Description("Creates a dump of emulated ARC files as they are written.")]
    [DefaultValue(LogSeverity.Information)]
    public bool DumpArc { get; set; } = false;
}
