...
using ARC.Stream.Emulator.Template;
...
public class Mod : ModBase // <= Do not Remove.
{
    ...
    public Mod(ModContext context)
    {
        ...
        _log.Info("Starting ARC.Stream.Emulator");
        _emulator = new ArcEmulator(_log, _configuration.DumpArc);
    ...
    public override void ConfigurationUpdated(Config configuration)
    {
        ...
        _configuration.DumpArc = configuration.DumpArc;
    }
    #endregion
