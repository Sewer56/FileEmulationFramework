...
namespace ARC.Stream.Emulator.Utilities;

/// <summary>
/// Verifies ARC header of a file.
/// </summary>
public static class ArcChecker
{
    /// <summary>
    /// Checks if a file with a given handle is an ARC file.
    /// </summary>
    /// <param name="handle">The file handle to use.</param>
    public static bool IsArcFile(IntPtr handle)
    {
        ...
        try
        {
            return Read<int>(fileStream) == 0x4C435241; // 'ARCL'
        }
        finally
        {
            fileStream.Dispose();
