...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "Reloaded.Universal.FileEmulationFramework.csproj",
    $PackageName = "Reloaded.Universal.FileEmulationFramework",
    ...
    $NuGetPackageId = "Reloaded.Universal.FileEmulationFramework",
