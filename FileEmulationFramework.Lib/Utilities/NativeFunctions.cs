...
internal unsafe struct NativeFunctions
{
    ...
    {
        var krn32Handle = LoadLibrary("kernel32.dll");
        _mapViewOfFileEx = (delegate* unmanaged[Stdcall]<IntPtr, uint, uint, uint, IntPtr, IntPtr, IntPtr>) GetProcAddress(krn32Handle, "MapViewOfFileEx");
        _unMapViewOfFileEx = (delegate* unmanaged[Stdcall]<IntPtr, uint, uint>)GetProcAddress(krn32Handle, "UnmapViewOfFileEx");
    }
